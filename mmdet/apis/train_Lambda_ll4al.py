...
from mmdet.utils.Epoch_Based_Runner_Lambda_ll4al import MyEpochBasedRunnerLambdall4al
...
def train_detector_ll4al(model, dataset, cfg, distributed=False, validate=False, timestamp=None, meta=None):
    ...
    runner.optimizer_ll = torch.optim.SGD(list(model.module.bbox_head.ll_model.parameters()) , lr = cfg.optimizer.lr,
