...
class Lambda_L1Net(L_AnchorHead):
    def __init__(self,
                 num_classes,
                 in_channels,
                 stacked_convs=4,
        ...
        self.isTrainD = False
        super(Lambda_L1Net, self).__init__(num_classes, in_channels, anchor_generator=anchor_generator, init_cfg=init_cfg, **kwargs)
    ...
    def loss_single_L(self, L_score, loss, label_weights, bbox_weights, **kwargs):
        ...
        loss_L = (loss_L * weights).abs().mean()*5
