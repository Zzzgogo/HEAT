...
runner = dict(type='MyEpochBasedRunnerLambdaclass', max_epochs=3)

# dataset settings
dataset_type = 'VOCDataset'
data_root = 'D:/course/meeting/shujuji/VOCdevkit/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=[
                data_root + 'VOC2007/ImageSets/Main/train1.txt'
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'VOC2007/ImageSets/Main/test1.txt',
        img_prefix=data_root + 'VOC2007/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=[
            data_root + 'VOC2007/ImageSet/Main/train1.txt',
            #data_root + 'VOC2012/ImageSets/Main/trainval.txt',
        ],
        #img_prefix=[data_root + 'VOC2007/', data_root + 'VOC2012/'],
        img_prefix=[data_root + 'VOC2007/'],
