...
from mmdet.apis.train_Lambda_ll4al import train_detector_ll4al
from mmdet.datasets import build_dataset, build_dataloader
from mmdet.models import build_detector
from mmdet.utils import collect_env, get_root_logger
from mmdet.utils.active_datasets_ll4al import *
...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path',
                        default = base_dir+'configs/_base_/Config_RetinaNet_ll4al.py',
                        )
        ...
        for cycle in cfg.cycles:
            ...
            for epoch in range(cfg.outer_epoch):
                ...
                if epoch == 0:
                    ...
                    train_detector_ll4al(model, datasets, cfg, distributed=distributed,
                ...
                cfg.total_epochs = cfg.epoch_ratio[0]
                cfg_bak = cfg.deepcopy()
                eval_res = train_detector_ll4al(model, datasets, cfg, distributed=distributed,
                                            validate=(not args.no_validate), timestamp=timestamp, meta=meta)
                cfg = cfg_bak
                torch.cuda.empty_cache()
            ...
            if cycle == cfg.cycles[-1]:
                ...
                cfg_name = osp.splitext(osp.basename(args.config))[0]
                save_name = f'{cfg.save_dir}/{cfg_name}_Cycle{cycle}_Epoch{cfg.runner.max_epochs}_seed{(seed+1)*10}_mycode.pth'
